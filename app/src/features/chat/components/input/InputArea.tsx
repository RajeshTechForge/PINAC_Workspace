...
import { promptsData } from "@/config/promptsData";
...
export const InputArea: React.FC<InputAreaProps> = ({
  ...
  const handleFileUpload = async () => {
    ...
    if (filePath) {
      attachment.setAttachmentFromPath(filePath);
    }
  };
  ...
  return (
    <div className="aline-with-msgBox mt-[10px] flex flex-col items-center justify-center">
      ...
      >
        ...
        {attachment.attachment && !attachment.isAttachmentUsed && (
            ...
            <div className="flex items-center gap-2 bg-gray-700 dark:bg-primary-dark p-2 pr-3 rounded-2xl w-fit">
              ...
              <div>
                <div className="text-white">
                  {attachment?.attachment.nameWithoutExtension}
                </div>
        ...
        <div className="flex items-center justify-between pl-2 relative">
          ...
          <div className="flex items-center gap-2 text-sm font-medium text-zinc-700 dark:text-gray-100">
            ...
            ${
              attachment.isAttachmentUsed
                ? "opacity-50 cursor-not-allowed"
                : " cursor-pointer"
            }`}
              disabled={attachment.isAttachmentUsed} // Disable button when a attachment is under use
            >
              <FiPlus size={20} />
            </button>
